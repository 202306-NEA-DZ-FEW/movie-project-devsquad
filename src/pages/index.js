...
export default function Home({ latestMovies, trendingMovies, popularSeries }) {
  return (
    <>
      <MovieLoop />
      <h1 className="rounded pr-2 pt-1 pb-1 w-full md:w-full lg:w-2/4 text-center md:text-center lg:text-end bg-gradient-to-r from-sky-950 to-slate-500 w-2/4 bg-primary text-center md:text-center lg:text-end ml-auto text-3xl mt-10 mb-10">
