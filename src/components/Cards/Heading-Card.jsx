const HeadingCard = ({ movie }) => {
  ...
  return (
    <>
      <div className="card card-side bg-gradient-to-r from-sky-950 from-10% via-indigo-950 via-30% to-slate-500 shadow-xl h-full w-full transition-opacity duration-500 ease-in-out">
