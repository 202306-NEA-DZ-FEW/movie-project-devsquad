...
function MovieCard({ title, release_date, overview, popularity, poster_path }) {
  return (
    <>
      <div className="card w-full shadow-xl h-full rounded-md transform hover:scale-105 transition-transform duration-300 ease-in-out">
        ...
        <div className="card-body rounded-b-lg grid cols-4 p-0 h-1/4 bg-gradient-to-r from-sky-950 via-30% to-slate-500">
